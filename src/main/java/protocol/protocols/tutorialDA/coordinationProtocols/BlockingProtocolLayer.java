...
public class BlockingProtocolLayer extends Layer {

    ReplicatedObject obj;
    Analyzer analyzer;
    public BlockingProtocolLayer(ReplicatedObject o, Analyzer a)
    {
    ...
    public Session createSession() {
        return new BlockingProtocolSession(this, obj, analyzer);
    }
}

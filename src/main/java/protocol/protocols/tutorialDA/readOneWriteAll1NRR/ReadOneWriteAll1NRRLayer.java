...
/**
 * The Read-One-Write-All Regular (1,N) Register algotithm.
 * 
 * @author alexp
 */
public class ReadOneWriteAll1NRRLayer extends Layer {

  public ReadOneWriteAll1NRRLayer() {
  ...
  public Session createSession() {
    return new ReadOneWriteAll1NRRSession(this);
  }
}

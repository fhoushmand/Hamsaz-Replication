 ...
 */
public class OrderProposal2 extends Proposal {
    ...
    public OrderProposal2(byte[] bytes) {
        this.bytes = bytes;
    }
    ...
    public int compareTo(Proposal other) {
        ...
        byte[] bytes_other = ((OrderProposal2) other).bytes;
    ...
    float averageSeq(OrderProposal2 op) {
        int seqCounter = 0;
        int curPos = 0;
    ...
    float averagePort(OrderProposal2 op) {
        int portCounter = 0;
        int curPos = 0;
        int nElem = byteArrayToInt(bytes, curPos);
        // num_elem

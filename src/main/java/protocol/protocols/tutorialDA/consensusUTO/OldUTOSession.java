 ...
 */
public class OldUTOSession extends Session {
     ...
     */
    private LinkedList<ListElement2> delivered;
     ...
     * unit: sendable event+seq number (ListElement)
     */
    private LinkedList<ListElement2> unordered;
    ...
    public void handleChannelInit(ChannelInit e) {
        ...
        delivered = new LinkedList<ListElement2>();
        unordered = new LinkedList<ListElement2>();
    ...
    public void handleSendableEventUP(SendableEvent e) {
        ...
        if (unordered.size() != 0 && !wait) {
            ...
            try {
                ...
                OrderProposal2 op = new OrderProposal2(bytes);
                cp.value = op;
    ...
    public void handleConsensusDecide(ConsensusDecide e) {
        ...
        LinkedList<ListElement2> decided = deserialize(((OrderProposal2) e.decision).bytes);
...
//    }
     ...
     *
     */
    LinkedList<ListElement2> sort(LinkedList<ListElement2> list) {
        return list;
    }
     ...
     *
     */
    private byte[] serialize(LinkedList<ListElement2> list) {
     ...
     *
     */
    private LinkedList<ListElement2> deserialize(byte[] data) {

        LinkedList<ListElement2> ret = new LinkedList<ListElement2>();
        int curPos = 0;
        ...
        for (int i = 0; i < listSize; i++) {
            try {
                ...
                ListElement2 le = new ListElement2(se, seq);
...
class ListElement2 {
    ...
    public ListElement2(SendableEvent se, int seq) {
        this.se = se;
        this.seq = seq;
    }

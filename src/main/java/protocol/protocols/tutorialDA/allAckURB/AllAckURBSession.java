 ...
 */
package main.java.protocol.protocols.tutorialDA.allAckURB;
...
import main.java.protocol.protocols.tutorialDA.utils.MessageEntry;
 ...
 * @author nuno
 */
public class AllAckURBSession extends Session implements Runnable {
  ...
  private void urbBroadcast(SendableEvent event) {
    ...
    try {
//        event.getMessage().pushObject(payload);
      event.go();
    } catch (AppiaEventException e) {
      e.printStackTrace();
    }

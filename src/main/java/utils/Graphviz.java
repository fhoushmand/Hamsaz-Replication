...
public class Graphviz
{
     ...
     */
    private static String DOT = Utils.configFile.getProperty("dotFor" + Constants.osName);
    ...
    public int writeGraphToFile(byte[] img, File to)
    {
        ...
        catch (NullPointerException ioe) { return -1; }
        return 1;
    }
    ...
    private byte[] get_img_stream(File dot, String type)
    {
        ...
        try {
            ...
            System.out.println("Error: in I/O processing of tempfile in dir " + Graphviz.TEMP_DIR + " or in calling external command");
//            ioe.printStackTrace();
        }
...
//            fout.write(str);
//
            temp = new File(Graphviz.TEMP_DIR+"dotsource.dot");
...
//        createDotGraph(dotFormat, "etc/DotGraph");
//    }
